...
\subsubsection{Reevaluation Approach}
\todo{Add Ref to "DSM Editor"}
Because of the size and density of the DSM, manual inspection alone made it difficult to identify clustering patterns, particularly when influenced by the Initial Level I perspective. The team therefore leveraged DSM analysis tooling to support clustering and visualization
