...
\newcommand{\scorecolor}[1]{%
  ...
  \or red% 1
  \or orange% 2
  \or yellow!80!orange% 3
  \or green!50!orange% 4
  \or green!70!black% 5
  \else gray% fallback
  \fi
}
...
\newcommand{\scorebox}[1]{
  \raisebox{1mm}[3.5mm][1.5mm]{\tikz[baseline=0mm]{
    \fill[draw=black,fill=\scorecolor{#1}] (-2.5mm,-2.5mm) rectangle (2.5mm,2.5mm);
    \node {#1};
  }}
}
...
\begin{tabularx}{\textwidth}{@{} >{\raggedright\arraybackslash}m{9.5mm} c @{\hspace{1mm}} X c @{\hspace{1mm}} X @{}}
  \toprule
    \Th{ID} &
    \multicolumn{2}{p{1cm}}{\Th{Latency}} &
    \multicolumn{2}{p{1cm}}{\Th{Cost}} \\
  \midrule
  ...
  \midrule
    \row{C-09}{}{3}{5}{Regional geometry improves revisit but retains direct downlink limits.}{Specialized constellation reduces economies of scale.}
  \midrule
    \row{C-10}{}{3}{3}{Optical GEO relay improves access without full mesh networking.}{Adds relay terminal complexity but avoids constellation ISLs.}
  \midrule
